...
class FileOrganizerApp:
    def __init__(self, state: FileOrganizerAppState | None = None, output_dir: Path | None = None) -> None:
        self.state = state if state is not None else FileOrganizerAppState()
