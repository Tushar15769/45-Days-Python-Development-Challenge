"""Develop a Comprehensive Word Frequency Analysis Engine for Text Processing
...
class WordFrequencyApp:
    def __init__(self, state: WordFrequencyAppState | None = None, output_dir: Path | None = None) -> None:
        self.state = state if state is not None else WordFrequencyAppState()
