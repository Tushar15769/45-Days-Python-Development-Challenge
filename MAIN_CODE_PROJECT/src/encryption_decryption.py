...
class EncryptionDecryptionApp:
    def __init__(self, state: EncryptionDecryptionAppState | None = None, output_dir: Path | None = None) -> None:
        self.state = state if state is not None else EncryptionDecryptionAppState()
