...
class CountdownReminderApp:
    def __init__(self, state: CountdownReminderAppState | None = None, output_dir: Path | None = None) -> None:
        self.state = state if state is not None else CountdownReminderAppState()
