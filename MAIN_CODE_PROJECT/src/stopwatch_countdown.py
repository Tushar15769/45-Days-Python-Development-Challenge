...
@dataclass
class StopwatchCountdownAppState:
...
class StopwatchCountdownApp:
    def __init__(self, state: StopwatchCountdownAppState | None = None, output_dir: Path | None = None) -> None:
        self.state = state if state is not None else StopwatchCountdownAppState()
