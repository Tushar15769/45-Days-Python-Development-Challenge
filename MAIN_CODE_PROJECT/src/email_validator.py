...
class EmailValidatorApp:
    def __init__(self, state: EmailValidatorAppState | None = None, output_dir: Path | None = None) -> None:
        self.state = state if state is not None else EmailValidatorAppState()
